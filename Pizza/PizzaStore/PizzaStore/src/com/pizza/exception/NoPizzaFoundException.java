...
public class NoPizzaFoundException extends Exception{
	...
	String msg = "Pizza does not exist";
	 ...
	 */
	public NoPizzaFoundException(String message, Throwable cause, boolean enableSuppression,
	...
	public String toString() {
		return "NoPizzaFoundException [msg=" + msg + "]";
	}
